...
<body>
  ...
  <section class="pages-section container">
    <h1 class="text-center page_title">Modifier Une Réference </h1>
    <div class="row">
     <div class="col-lg-offset-3 col-lg-6 col-lg-offset-3 col-xs-12">
        <form class="form-horizontal" method="POST" action=<?php echo "../controllers/DeleteUpdateReference.php?id=".$_GET["id"]; ?> enctype="multipart/form-data">
          <div class="form-group" >
            <b>logo de la réference</b><br>
            <img style="border:solid 1px black;" height="100" width="100" src=<?php echo $image->url; ?> />
          </div>
          <div class="form-group">
             <label for="titre"><b>réference : </b></label>
             <input required type="text" value=<?php echo "\"".$image->alt."\""; ?> name="titre" id="titre" class="form-control"/>
          </div>
          <div class="form-group">
             <label for="reference_logo"><b><i class="kk kk-open-folder2"></i> changer l'image : </b></label>
             <input type="file" id="reference_logo" name="reference_logo" />
          </div>
