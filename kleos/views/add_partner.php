...
<body>
  ...
  <section class="pages-section container">
    <h1 class="text-center page_title">Ajouter Un Partenaire</h1>
    <div class="row">
     <div class="col-lg-offset-3 col-lg-6 col-lg-offset-3 col-xs-12">
        <form class="form-horizontal" method="POST" action="../controllers/fillPartnersPage.php" enctype="multipart/form-data">
          <div class="form-group">
             <label for="titre"><b>nom du partenaire : </b></label>
             <input required type="text" name="titre" id="titre" class="form-control"/>
          </div>
          <div class="form-group">
             <label for="partner_logo"><b><i class="kk kk-open-folder2"></i> logo partenaire : </b></label>
             <input required type="file" id="partner_logo" name="partner_logo" />
          </div>
          <div class="form-group">
